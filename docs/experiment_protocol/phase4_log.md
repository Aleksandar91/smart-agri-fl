...
Audit: `phase4_audit.json` — 90/90, 0 fit/eval failures; label-flip only on the locked attacker; typical duration 6.5 min (5.5–7.5); one stall `iid-s503-fedavg-e1-flip1-apple` ~8.1 h (Docker stall, not extra training); training wall-clock 25 August 12:41 UTC to 26 August 06:29 UTC.
